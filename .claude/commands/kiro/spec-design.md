...
- `.cupola/specs/$1/spec.json`, `requirements.md`, `design.md` (if exists)
- **Entire `.cupola/steering/` directory** for complete project memory
- `.cupola/settings/templates/specs/design.md` for document structure
- `.cupola/settings/rules/design-principles.md` for design principles
- `.cupola/settings/templates/specs/research.md` for discovery log structure
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   - Read and execute `.cupola/settings/rules/design-discovery-full.md`
   ...
   **For Extensions**:
   - Read and execute `.cupola/settings/rules/design-discovery-light.md`
...
- Create or update `.cupola/specs/$1/research.md` using the shared template
...
1. **Status**: Confirm design document generated at `.cupola/specs/$1/design.md`
...
**Note**: The actual design document follows `.cupola/settings/templates/specs/design.md` structure.
...
- **User Message**: "No requirements.md found at `.cupola/specs/$1/requirements.md`"
- **Suggested Action**: "Run `/kiro:spec-requirements $1` to generate requirements first"

**Template Missing**:
- **User Message**: "Template file missing at `.cupola/settings/templates/specs/design.md`"
...
- **Default**: Use full discovery process (`.cupola/settings/rules/design-discovery-full.md`)
...
**If Design Approved**:
- Review generated design at `.cupola/specs/$1/design.md`
