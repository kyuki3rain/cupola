...
- If no history found, scan `.cupola/specs/` for features with completed tasks `[x]`

**If feature provided** (`$1` present, `$2` empty):
- Use specified feature
- Detect all completed tasks `[x]` in `.cupola/specs/$1/tasks.md`
...
- Read `.cupola/specs/<feature>/spec.json` for metadata
- Read `.cupola/specs/<feature>/requirements.md` for requirements
- Read `.cupola/specs/<feature>/design.md` for design structure
- Read `.cupola/specs/<feature>/tasks.md` for task list
- **Load ALL steering context**: Read entire `.cupola/steering/` directory including:
