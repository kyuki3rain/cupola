...
1. **Load Context**:
   ...
   - Read `.cupola/specs/$1/requirements.md` for requirements
   - Read `.cupola/specs/$1/design.md` for design document
...
2. **Read Review Guidelines**:
   - Read `.cupola/settings/rules/design-review.md` for review criteria and process
