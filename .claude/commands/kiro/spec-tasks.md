...
- `.cupola/specs/$1/spec.json`, `requirements.md`, `design.md`
- `.cupola/specs/$1/tasks.md` (if exists, for merge mode)
...
- Read `.cupola/settings/rules/tasks-generation.md` for principles
- If `sequential` is **false**: Read `.cupola/settings/rules/tasks-parallel-analysis.md` for parallel judgement criteria
- Read `.cupola/settings/templates/specs/tasks.md` for format (supports `(P)` markers)
...
**Write and update**:
- Create/update `.cupola/specs/$1/tasks.md`
...
1. **Status**: Confirm tasks generated at `.cupola/specs/$1/tasks.md`
2. **Task Summary**: 
...
- **User Message**: "Missing requirements.md or design.md at `.cupola/specs/$1/`"
...
- **User Message**: "Template or rules files missing in `.cupola/settings/`"
