...
1. **Load Context**:
   - Read `.cupola/specs/$1/spec.json` for language and metadata
   - Read `.cupola/specs/$1/requirements.md` for project description
...
2. **Read Guidelines**:
   - Read `.cupola/settings/rules/ears-format.md` for EARS syntax rules
   - Read `.cupola/settings/templates/specs/requirements.md` for document structure
...
- Review generated requirements at `.cupola/specs/$1/requirements.md`
