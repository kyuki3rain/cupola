...
- [x] 1. inputs ディレクトリクリア関数の実装
- [x] 1.1 `clear_inputs_dir` 関数を io.rs に追加する
...
- [x] 2. prepare_inputs へのクリア処理の組み込み
- [x] 2.1 `prepare_inputs` の先頭で `clear_inputs_dir` を呼び出す
...
- [x] 3. ユニットテストの追加
- [x] 3.1 `clear_inputs_dir` のユニットテストを io.rs に追加する
