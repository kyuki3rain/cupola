...
- [ ] 1. step3 に stale exit ガード条件を追加する

- [ ] 1.1 プロセス終了後、issue 状態が処理不要な場合にスキップするガードを実装する
...
- [ ] 2. stale exit スキップのユニットテストを追加する

- [ ] 2.1 needs_process が false の issue に対して失敗終了がイベントを発行しないことを検証する
...
- [ ] 2.2 PR マージ・Issue クローズ後の競合シナリオでスキップが正常動作することを検証する
