...
- [ ] 1. Idle 状態のときのみラベルアクター検証を行うよう変更する
- [ ] 1.1 ポーリング対象 issue の状態を受け取り、Idle 状態のときのみ外部 API を呼び出してラベルアクターを検証するよう条件分岐を追加する
...
- [ ] 2. テストを更新・追加する
- [ ] 2.1 (P) Idle 状態を前提とする既存のラベルアクター検証テストを更新する
...
- [ ] 2.2 (P) 非 Idle 全状態でラベルアクター外部 API が呼ばれないことを検証するテストを追加する
