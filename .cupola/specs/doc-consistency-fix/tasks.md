...
- [ ] 1. (P) steering/tech.md の CLIサブコマンド名を実装と一致させる
- [ ] 1.1 (P) サブコマンド一覧の更新
...
- [ ] 2. (P) CHANGELOG.md に start/stop デーモン機能を記載する
