...
- [x] 1. Release ワークフローの基本構造を作成する
- [x] 1.1 ワークフローファイルを作成し、タグ push トリガーと matrix 設定を定義する
...
- [x] 2. ビルドステップを実装する
- [x] 2.1 (P) Rust ツールチェーンのセットアップとキャッシュを設定する
...
- [x] 3. アーカイブ作成とリリースアップロードを実装する
- [x] 3.1 バイナリを tar.gz アーカイブにパッケージングするステップを実装する
...
- [x] 3.2 GitHub Release へのアップロードステップを実装する
