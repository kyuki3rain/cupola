...
- [x] 1. リトライ上限到達時に必要な失敗情報を保持できるようにする
- [x] 1.1 上限到達コメント用の Effect がプロセスタイプと連続失敗回数を持てるようにする
...
- [x] 2. 各プロセスの上限到達時に失敗情報を正しく引き継げるようにする
- [x] 2.1 上限到達を表す遷移でプロセスタイプと連続失敗回数を受け取れるようにする
...
- [x] 4.3 上限到達コメントで新しいペイロードが使われることを検証する
...
- [x] 5. 変更後も品質ゲートを満たすことを確認する
- [x] 5.1 静的解析とテストが警告・失敗なく完了することを確認する
