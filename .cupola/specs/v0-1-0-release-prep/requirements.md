...
5. The cupola repository shall include a footer with a link for version `0.1.0` (e.g., `[0.1.0]: https://github.com/.../releases/tag/v0.1.0`) and comparison links for subsequent versions (e.g., `[0.1.1]: https://github.com/.../compare/v0.1.0...v0.1.1`).
