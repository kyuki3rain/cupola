...
- [x] 1. DB接続ラッパーの mutex lock エラー伝搬
- [x] 1.1 (P) `init_schema` 内の mutex lock を安全化
...
- [x] 2. 実行ログリポジトリの mutex lock および spawn_blocking エラー伝搬
- [x] 2.1 (P) `record_start`、`record_finish`、`find_by_issue` の mutex lock を安全化
...
- [x] 2.2 (P) `record_start`、`record_finish`、`find_by_issue` の spawn_blocking await を安全化
...
- [x] 3. Issue リポジトリの mutex lock および spawn_blocking エラー伝搬
- [x] 3.1 (P) 全8メソッドの mutex lock を安全化
...
- [x] 3.2 (P) 全8メソッドの spawn_blocking await を安全化
