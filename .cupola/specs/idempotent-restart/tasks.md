...
- [ ] 2.3 (P) GitHubClientImpl に get_pr_status を実装する
...
- [ ] 3. (P) TransitionUseCase から RetryExhausted 時の cleanup を削除する
...
- [ ] 5. CleanupUseCase を新規実装する
- [ ] 5.1 CleanupUseCase の実装本体を作成する
...
- [ ] 5.2 CleanupUseCase の実行結果を標準出力に表示する機能を追加する
...
- [ ] 6. PollingUseCase を修正する
- [ ] 6.1 initialize_issue を冪等化する
...
- [ ] 6.2 step7_spawn_processes にスポーン前 PR 状態チェックを追加する
...
- [ ] 8. テストを追加・更新する
- [ ] 8.1 reset_for_restart のフィールド保持を検証するテストを追加する
...
- [ ] 8.6 (P) CleanupUseCase のテストを追加する
...
- [ ] 8.7 (P) CLI の Cleanup サブコマンドパースをテストする
