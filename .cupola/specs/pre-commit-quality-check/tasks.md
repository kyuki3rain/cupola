...
- [x] 1. 設計エージェントプロンプトに品質チェック手順を追加する
- [x] 1.1 `build_design_prompt` のプロンプト文字列に品質チェックセクションを追加する
...
- [x] 2. 実装エージェントプロンプトに品質チェック手順を追加する
- [x] 2.1 `build_implementation_prompt` のプロンプト文字列に品質チェックセクションを追加する
...
- [x] 3. レビュー対応エージェントプロンプトに品質チェック手順を追加する
- [x] 3.1 `build_fixing_prompt` のプロンプト文字列に品質チェックセクションを追加する
...
- [x] 4. 品質チェック手順の存在を検証するユニットテストを追加する
- [x] 4.1 (P) 設計プロンプトの品質チェック内容を検証するテストを追加する
...
- [x] 5. 既存テストとの整合性を確認する
- [x] 5.1 既存ユニットテストがすべてパスすることを確認する
