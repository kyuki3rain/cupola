...
- [ ] 1. PidFilePort トレイトに ProcessMode 型と新しいメソッドを追加する
- [ ] 1.1 ProcessMode 列挙型を定義する
...
- [ ] 2.2 `read_pid_and_mode` を実装する（2行＋レガシー1行の後方互換処理）
...
- [ ] 3. 起動時の呼び出しサイトを `write_pid_with_mode` に更新する
- [ ] 3.1 foreground 起動の呼び出しサイトを更新する
