...
- [ ] 5.1 settings.json 書き込みインターフェースを追加する
  - ファイル生成コンポーネントが `ClaudeSettings` を受け取り settings.json を書き込める契約が定義されること
  - _Requirements: 4.1, 4.2, 4.3, 4.4_

- [ ] 5.2 settings.json 書き込みと deep merge を実装する
