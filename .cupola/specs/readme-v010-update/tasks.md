...
- [ ] 2. CLI コマンドリファレンスを全面更新する
- [ ] 2.1 `cupola start` コマンドのドキュメントを更新する
...
- [ ] 3. Configuration Reference を更新する
- [ ] 3.1 `max_concurrent_sessions` と `model` を設定項目テーブルに追加する
...
- [ ] 5. Limitations セクションを新設する
- [ ] 5.1 既知の制限事項を記載する独立セクションを作成する
...
- [ ] 6. Architecture Overview のファイルツリーを現状に同期する
- [ ] 6.1 ファイルツリーを実際の `src/` 構造で全面置換する
...
- [ ] 7. Installation セクションを更新する
- [ ] 7.1 リポジトリ URL と手順内のコマンドを修正する
...
- [ ] 8. README.md の全体整合性を検証する
- [ ] 8.1 全要件の受け入れ条件を目視確認する
