...
- [x] 1. ProcessRunRepository トレイトに find_latest_with_pr_number メソッドを追加する
...
- [x] 2. SqliteProcessRunRepository に find_latest_with_pr_number を実装する
...
- [x] 3. observe_pr_for_type を find_latest_with_pr_number を使用するよう更新する
...
- [x] 4. テストを追加して動作を検証する
  - [x] 4.1 (P) observe_pr_for_type のユニットテストを追加する
  ...
  - [x] 4.2 (P) find_latest_with_pr_number のインテグレーションテストを追加する
    - インメモリSQLiteを使用する
