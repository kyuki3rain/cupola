...
- [ ] 1. sqlite_issue_repository のサイレントフォールバック修正

- [ ] 1.1 str_to_state の戻り型を Result に変更する
...
- [ ] 1.4 parse_sqlite_datetime の戻り型を Result に変更する
...
- [ ] 3.1 str_to_state と parse_sqlite_datetime のユニットテストを追加する
...
- [ ] 3.3 reset_for_restart 後の fixing_causes が空配列になることを確認する
