...
- [x] 1. シグナル失敗パスの PID ファイルクリーンアップ実装

- [x] 1.1 SIGTERM エラーパスの修正
...
- [x] 2.1 (P) SIGTERM 失敗 + プロセス死亡シナリオのテスト
...
- [x] 2.2 (P) SIGKILL 失敗 + プロセス死亡シナリオのテスト
...
- [x] 2.3 SIGTERM 失敗 + プロセス生存シナリオのテスト
