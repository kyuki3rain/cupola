...
- [x] 1. max_retries ゼロ値バリデーションの追加
- [x] 1.1 Config::validate に max_retries のゼロ値チェックを追加する
...
- [x] 2. max_retries バリデーションのユニットテスト追加
- [x] 2.1 ゼロ値拒否テストの追加
