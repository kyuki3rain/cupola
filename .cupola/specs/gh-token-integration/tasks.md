...
- [x] 2. resolve_github_token() を gh_token::get() に置き換える

- [x] 2.1 (P) github_rest_client.rs から resolve_github_token() を削除する
...
- [x] 2.2 (P) bootstrap/app.rs の呼び出し箇所を gh_token::get() に変更する
