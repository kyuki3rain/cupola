...
- [ ] 1. JSON スキーマ定数の description を英語化する
- [ ] 1.1 `PR_CREATION_SCHEMA` の description フィールドを英語化する
...
- [ ] 1.2 `FIXING_SCHEMA` の description フィールドを英語化する
...
- [ ] 2. `GENERIC_QUALITY_CHECK_INSTRUCTION` 定数を英語化する
...
- [ ] 3. `build_design_prompt` 関数のプロンプト本文を英語化する
...
- [ ] 4. `build_implementation_prompt` 関数のプロンプト本文を英語化する
  - プロンプトの見出し・説明・手順をすべて英語化する
...
- [ ] 5. `build_fixing_prompt` 関数のプロンプト本文を英語化する
- [ ] 5.1 プロンプト本文（静的部分）を英語化する
...
- [ ] 5.2 動的文字列（各 `FixingProblemKind` 分岐）を英語化する
