...
- [ ] 1. SessionManager に log_id 保持機能を追加する
- [ ] 1.1 SessionEntry と ExitedSession に log_id フィールドを追加する
...
- [ ] 2. PollingUseCase の実行ログ記録フローを修正する
- [ ] 2.1 step7_spawn_processes でプロセス spawn 後に実行ログの開始を記録する
...
- [ ] 2.2 step3_process_exit_check から record_start を削除し session.log_id を使用する
...
- [ ] 3. 修正後の実行ログ記録フローを検証するテストを追加・更新する
- [ ] 3.1 step7 で record_start が呼ばれ、step3 で record_start が呼ばれないことを検証する
