...
- [x] 1. InitFileGenerator の実装
- [x] 1.1 (P) cupola.toml 雛形生成機能を実装する
...
- [x] 1.2 (P) steering テンプレートコピー機能を実装する
...
- [x] 1.3 (P) .gitignore エントリ追記機能を実装する
...
- [x] 2. InitUseCase の実装と bootstrap 統合
- [x] 2.1 InitUseCase を作成し、全初期化ステップを統括する
...
- [x] 2.2 app.rs の Command::Init ハンドラを InitUseCase 呼び出しに置き換える
  - 既存のインライン SQLite 初期化コードを削除し、InitUseCase::run() に委譲する
  - InitReport の内容に基づいて完了メッセージを出力する
  - _Requirements: 1.1, 1.2_

- [x] 3. テストの実装
- [x] 3.1 (P) InitFileGenerator の各メソッドのユニットテストを追加する
...
- [x] 3.2 (P) InitUseCase の統合テストを追加する
